...
parser.add_argument('--s_init', type=str, default='./results/base/new-c100-resnet20/initial_r20.pth.tar')
parser.add_argument('--t_model1', type=str, default='./results/base/new-c100-resnet110/model_best.pth.tar')
parser.add_argument('--t_model2', type=str, default='./results/base/new-c100-resnet56/model_best.pth.tar')
...
parser.add_argument('--note', type=str, default='ours-double', help='file name')
parser.add_argument('--data_name', type=str, default='cifar100', help='name of dataset')
parser.add_argument('--t1_name', type=str, default='resnet110', help='name of teacher network')
parser.add_argument('--t2_name', type=str, default='resnet56', help='name of teacher network')
parser.add_argument('--s_name', type=str, default='resnet20',help='name of student network')
